...
def 读取配置(配置项: str) -> None | str | tuple[str, str] | bool:
    '''
    [验证/转换后的配置值]  
    ...
    # {
    #     "version": "1.3.4", -> str
    #     "winget-pkgs": "D:\\指向仓库的路径\\winget-pkgs", -> exists? -> str
    #     "winget-tools": "D:\\指向仓库的路径\\winget-tools", -> exists? -> str
